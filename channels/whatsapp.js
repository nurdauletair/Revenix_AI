...
Важно:
Не пиши, что клиент просит менеджера, если в подписи нет прямой просьбы к менеджеру.
`
            );
...
Реальное сообщение/подпись клиента:
${caption || "без подписи"}
...
Важно:
Это НЕ просьба менеджера.
Это фото от клиента для консультации.
Не передавай менеджеру, если клиент прямо не просит менеджера, звонок, оператора или человека.
